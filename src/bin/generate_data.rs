...
const OCCUPATIONS: &[&str] = &[
    "Engineer", "Teacher", "Developer", "Manager", "Sales", "Nurse", "Accountant", "Designer",
    "Analyst", "Consultant", "Administrator", "Technician", "Specialist", "Coordinator", "Director",
    "Architect", "Lawyer", "Doctor", "Pharmacist", "Therapist", "Writer", "Artist", "Chef",
    "Mechanic", "Electrician", "Plumber", "Carpenter", "Driver", "Operator", "Clerk",
];
...
fn generate_applicant(id: u32, rng: &mut impl Rng) -> String {
    ...
    let blood_pressure_dia = ((blood_pressure_sys as f64 * 0.6) + rng.gen_range(-5.0..5.0)).clamp(60.0, 110.0) as u32;
    ...
    // Coverage amount
    let coverage_amounts = [250000, 300000, 350000, 400000, 450000, 500000, 550000, 600000, 750000, 1000000, 1500000];
    ...
    format!(
        "{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}",
        id, name, age, gender, smoker, occupation, annual_income, bmi,
        blood_pressure_sys, blood_pressure_dia, cholesterol,
        existing_conditions, family_history_score, coverage_amount, coverage_years
    )
}
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("✓ Complete! Generated {} records in {:.2}s", num_records, elapsed.as_secs_f64());
